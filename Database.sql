...
END;
--CRIA A TABELA DE PROFISSOES PRA PF
IF NOT EXISTS(
  SELECT *
  FROM sysobjects
...
END;
--CRIA O INDEX PARA O ENDERECO PRINCIPAL
IF NOT EXISTS(
  SELECT *
  FROM sysobjects
...
END;
--CRIA O INDEX PARA O CONTATO PRINCIPAL
IF NOT EXISTS(
  SELECT *
  FROM sysobjects
